...
let repTitleOneMob = document.querySelector('.rep_titleMob.one')
let repTitleTwoMob = document.querySelector('.rep_titleMob.two')
let repTitleThreeMob = document.querySelector('.rep_titleMob.three')

let repTitleMobOneB = document.querySelector('.rep_titleMob.one b')
let repTitleMobTwoB = document.querySelector('.rep_titleMob.two b')
let repTitleMobThreeB = document.querySelector('.rep_titleMob.three b')

let compTitleValMob = document.getElementById('compMob_1')
let compTitleValTwoMob = document.getElementById('compMob_2')
let compTitleValThreeMob = document.getElementById('compMob_3')
...
function showHouses(n) {
    ...
    function update() {
      let inp = document.getElementById("ageInputId");
        ...
        if(workIndex === 1){
          repTitleMobOneB.textContent = 6900
          repTitleMobTwoB.textContent = 7700
          repTitleMobThreeB.textContent = 8600
        }

        if(workIndex === 2){ 
          repTitleMobOneB.textContent = 5900
          repTitleMobTwoB.textContent = 6700
          repTitleMobThreeB.textContent = 7600
        } 

        if(workIndex === 3){ 
          repTitleMobOneB.textContent = 7900
          repTitleMobTwoB.textContent = 8700
          repTitleMobThreeB.textContent = 9600
        } 

        if(workIndex === 4){ 
          repTitleMobOneB.textContent = 8900
          repTitleMobTwoB.textContent = 9700
          repTitleMobThreeB.textContent = 10600
        } 
      }
